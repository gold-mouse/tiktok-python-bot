...
class RequestModifier:
    ...
    @querystring.setter
    def querystring(self, querystring): # -> None:
    ...
    @property
    def rewrite_rules(self): # -> list[tuple[Any, Any]]:
    ...
    def modify_request(self, request, urlattr=..., methodattr=..., headersattr=..., bodyattr=...): # -> None:
    ...
    def modify_response(self, response, request, urlattr=..., headersattr=...): # -> None:
